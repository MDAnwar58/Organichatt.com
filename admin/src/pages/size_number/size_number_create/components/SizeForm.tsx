...
import useSizeNumberCreateContext from "../context/SizeNumberCreateContext";

export default function SizeForm() {
  const { name, form, addHandle } = useSizeNumberCreateContext();
  ...
  return (
    <div className="mx-auto 2xl:w-4/12 xl:w-5/12 lg:w-6/12 sm:w-8/12 w-full pt-0  bg-gray-50 dark:bg-gray-800 shadow-sm border dark:border-gray-900 rounded-md mt-28">
      <FormHeader title="Size Number Added" />
