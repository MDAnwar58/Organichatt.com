...
const WishList2Icon = () => {
    return (
      <MdFavorite className=" border-1 border-gray-300 text-gray-500 bg-white text-2xl rounded-md mb-1 me-2" />
    );
}
const Cart2Icon = () => {
    return (
      <MdShoppingCart className=" border-1 border-gray-300 text-gray-500 bg-white text-2xl rounded-md mb-1 me-2" />
    );
}
const ViewIcon = () => {
    return (
      <GrFormView className=" border-1 border-gray-300 text-gray-500 bg-white text-2xl rounded-md mb-1 me-2" />
    );
}
const ViewerIcon = ({ cssStyle }) => {
  return (
    <HiOutlineViewfinderCircle className={cssStyle} />
  );
};
const PlusIcon = () => {
    return <FaPlus className="text-md" />;
}
const MinusIcon = () => {
    return <FaMinus className="text-md" />;
}
const LayoutIcon = () => {
    return <LuLayoutGrid className="text-md" />;
}
const BackArrowIcon = () => {
    return <IoIosArrowBack className="text-md" />;
}
const ForwardArrowIcon = () => {
  return <IoIosArrowForward className="text-md" />;
};
const FavoriteIcon = ({ className }: { className?: string }) => {
  return <MdFavoriteBorder className={className} />;
};
const ThreeDotBarIcon = ({ className }: { className?: string }) => {
  return <AiOutlineBars className={className} />;
};
