            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-10 sm:grid-cols-4">
                <div>
                    <a href="https://flowbite.com/" class="flex items-center">
                        <img src="{{ asset('assets/images/organic-logo.png') }}" class="h-16 w-44 me-3"
                            alt="FlowBite Logo" />
                    </a>
                    <p class="pt-3 text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime dolor
                        error
                        sapiente quam earum
                        at
                        nisi eveniet sed maiores quae!</p>
                </div>
                <div>
